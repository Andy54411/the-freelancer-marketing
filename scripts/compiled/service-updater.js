...
var SERVICE_REPLACEMENTS = [
  ...
  // STOCK MOVEMENTS COLLECTION
  {
    ...
    newPattern: function () {
      return "collection(db, 'companies', companyId, 'stockMovements')";
    },
  ...
  // TIME ENTRIES COLLECTION
  {
    ...
    newPattern: function () {
      return "collection(db, 'companies', companyId, 'timeEntries')";
    },
  ...
  // QUOTES COLLECTION
  {
    ...
    newPattern: function () {
      return "collection(db, 'companies', companyId, 'quotes')";
    },
  ...
  // ORDER TIME TRACKING COLLECTION
  {
    ...
    newPattern: function () {
      return "collection(db, 'companies', companyId, 'orderTimeTracking')";
    },
  ...
  // DOC REFERENCES - CUSTOMERS
  {
    ...
    newPattern: function (match, customerId) {
      return "doc(db, 'companies', companyId, 'customers', ".concat(customerId, ')');
    },
  ...
  // DOC REFERENCES - INVENTORY
  {
    ...
    newPattern: function (match, itemId) {
      return "doc(db, 'companies', companyId, 'inventory', ".concat(itemId, ')');
    },
  ...
  // DOC REFERENCES - STOCK MOVEMENTS
  {
    ...
    newPattern: function (match, movementId) {
      return "doc(db, 'companies', companyId, 'stockMovements', ".concat(movementId, ')');
    },
  ...
  // DOC REFERENCES - TIME ENTRIES
  {
    ...
    newPattern: function (match, entryId) {
      return "doc(db, 'companies', companyId, 'timeEntries', ".concat(entryId, ')');
    },
  ...
  // DOC REFERENCES - QUOTES
  {
    ...
    newPattern: function (match, quoteId) {
      return "doc(db, 'companies', companyId, 'quotes', ".concat(quoteId, ')');
    },
  ...
  // DOC REFERENCES - EXPENSES
  {
    ...
    newPattern: function (match, expenseId) {
      return "doc(db, 'companies', companyId, 'expenses', ".concat(expenseId, ')');
    },
...
var ServiceUpdater = /** @class */ (function () {
  ...
  ServiceUpdater.prototype.updateFile = function (filePath) {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        for (
          _i = 0, SERVICE_REPLACEMENTS_1 = SERVICE_REPLACEMENTS;
          _i < SERVICE_REPLACEMENTS_1.length;
          _i++
        ) {
        ...
        if (hasChanges) {
          if (this.logResults) {
            ...
            appliedReplacements.forEach(function (desc) {
              return console.log('  \u2705 '.concat(desc));
            });
          }
          if (!this.dryRun) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        ...
        findInFile = function (filePath, pattern) {
          if (!fs_1.default.existsSync(filePath)) return [];
          ...
          for (_a = 0, patterns_1 = patterns; _a < patterns_1.length; _a++) {
            ...
            if (matches.length > 0) {
              ...
              matches.forEach(function (match) {
                return console.log('  '.concat(match));
              });
              console.log('');
            }
          }
  ...
  ServiceUpdater.prototype.findFilesRecursive = function (dir, pattern) {
    var results = [];
    if (!fs_1.default.existsSync(dir)) return results;
