  ...
  try {
    ...
    for (const companyDoc of companiesSnapshot.docs) {
      ...
      if (reviewsInSubcollection.size > 0) {
        console.log(`📊 Company ${companyId}: ${reviewsInSubcollection.size} Reviews in Subcollection`);
      }
    }
...
async function deleteOldReviews() {
  ...
  if (confirmation !== 'YES_DELETE_OLD_REVIEWS') {
    console.log('❌ Löschung abgebrochen. Setze DELETE_OLD_REVIEWS=YES_DELETE_OLD_REVIEWS um fortzufahren.');
    return;
  }
