...
// Firebase-Konfiguration für die Live-Umgebung
// WICHTIG: Ersetzen Sie diese Werte mit Ihren echten Firebase-Konfigurationsdaten
...
async function createTestReviews() {
    try {
        ...
        // Provider-ID - diese sollte durch eine echte Provider-ID ersetzt werden
        const providerId = "mietkoch-andy-provider-id"; // Hier die echte Provider-ID eintragen
        ...
        console.log('✅ Alle Test-Bewertungen erfolgreich erstellt!');
        ...
        console.log('\n⚠️  WICHTIG: Aktualisieren Sie die providerId in diesem Script mit der echten Provider-ID von Mietkoch Andy!');
        console.log('   Aktuelle providerId: ' + providerId);
