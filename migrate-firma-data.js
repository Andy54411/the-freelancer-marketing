  ...
  try {
    ...
    for (const userDoc of usersSnapshot.docs) {
      ...
      const firmaData = {
        ...
        // Adresse
        companyAddressLine1:
          userData.companyAddressLine1ForBackend || userData.step1?.personalStreet,
        companyCity: userData.companyCityForBackend || userData.step1?.personalCity,
        companyPostalCode:
          userData.companyPostalCodeForBackend || userData.step1?.personalPostalCode,
        companyCountry:
          userData.companyCountryForBackend || userData.step1?.personalCountry || 'DE',
        ...
        profilePictureFirebaseUrl:
          userData.profilePictureFirebaseUrl || userData.step3?.profilePictureURL,
    ...
    const miekochSnapshot = await db
      .collection('firma')
