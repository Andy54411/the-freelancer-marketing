 ...
 */
const lambdaOcrRequestSchema = z.object({
...
export const handler = async (
    ...
    try {
        ...
        const detectedMimeType = mimeType || downloadResult.contentType || detectFileType(fileBuffer, downloadResult.fileName);
