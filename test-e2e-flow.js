...
async function testCompleteFlow() {
  ...
  try {
    ...
    console.log(`Platform fee:         ${(applicationFee / 100).toFixed(2)}€ (transferred to your account)`);
    console.log(`Provider receives:    ${(availableAmount / 100).toFixed(2)}€ (available for payout)`);
    console.log(`Total verified:       ${((applicationFee + availableAmount) / 100).toFixed(2)}€ ✅`);
