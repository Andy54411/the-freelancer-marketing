    ...
    useEffect(() => {
        ...
        const fetchCompanyData = async () => {
            ...
            try {
                ...
                let data = { ...userSnap.data(), ...(companySnap.exists() ? companySnap.data() : {}) } as RawFirestoreUserData;
                ...
                const profilePicture = data?.profilePictureURL || data?.profilePictureFirebaseUrl || data?.step3?.profilePictureURL;
