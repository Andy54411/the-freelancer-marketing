...
export const useAnalytics = () => {
  ...
  const trackUserRegistration = useCallback((userType: 'user' | 'company' | 'employee') => {
  ...
  const trackProviderRegistration = useCallback((userType: 'company' | 'employee') => {
  ...
  const trackContactInteraction = useCallback((type: 'chat' | 'email' | 'phone' | 'form') => {
