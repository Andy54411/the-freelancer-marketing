                                        ...
                                        <div key={category.title} className="p-2">
                                            ...
                                            <ul className="mt-1">
                                                {category.subcategories.map(subcategory => (
                                                    <li key={subcategory}>
                                                        <Link
                                                            href={currentUser ? (company ? `/dashboard/company/${company.uid}/services/${encodeURIComponent(category.title.toLowerCase().replace(/\s+/g, '-'))}/${encodeURIComponent(subcategory.toLowerCase().replace(/\s+/g, '-'))}` : `/dashboard/user/${currentUser.uid}/services/${encodeURIComponent(category.title.toLowerCase().replace(/\s+/g, '-'))}/${encodeURIComponent(subcategory.toLowerCase().replace(/\s+/g, '-'))}`) : '/login'}
