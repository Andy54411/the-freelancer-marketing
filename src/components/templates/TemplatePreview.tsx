...
interface TemplatePreviewProps {
  documentType: 'Invoice' | 'Invoicereminder' | 'Order' | 'Contractnote' | 'Packinglist' | 'Letter' | 'Creditnote';
  templateId?: string;
  className?: string;
...
const getSampleTemplateData = (): TemplateProps => {
  return {
    ...
    companySettings: {
      ...
      logoUrl: '/revolut-business-logo.svg',
      address: {
        street: 'Musterstraße 123',
        zipCode: '12345',
        city: 'Musterstadt'
...
const NEW_TEMPLATES = {
  ...
  quote: [
    { id: 'professional-business-quote', name: 'Klassisch Professionell', component: ProfessionalBusinessQuoteTemplate },
    { id: 'executive-premium-quote', name: 'Executive Premium', component: ExecutivePremiumQuoteTemplate },
    { id: 'creative-modern-quote', name: 'Kreativ Modern', component: CreativeModernQuoteTemplate },
    { id: 'minimalist-elegant-quote', name: 'Minimalistisch Elegant', component: MinimalistElegantQuoteTemplate },
    { id: 'corporate-classic-quote', name: 'Corporate Klassisch', component: CorporateClassicQuoteTemplate },
    { id: 'tech-innovation-quote', name: 'Tech Innovation', component: TechInnovationQuoteTemplate }
  ],
  order: [
    { id: 'professional-business-order', name: 'Klassisch Professionell', component: ProfessionalBusinessOrderTemplate },
    { id: 'executive-premium-order', name: 'Executive Premium', component: ExecutivePremiumOrderTemplate },
    { id: 'creative-modern-order', name: 'Kreativ Modern', component: CreativeModernOrderTemplate },
    { id: 'minimalist-elegant-order', name: 'Minimalistisch Elegant', component: MinimalistElegantOrderTemplate },
    { id: 'corporate-classic-order', name: 'Corporate Klassisch', component: CorporateClassicOrderTemplate },
    { id: 'tech-innovation-order', name: 'Tech Innovation', component: TechInnovationOrderTemplate }
  ],
  letter: [
    { id: 'professional-business-letter', name: 'Klassisch Professionell', component: ProfessionalBusinessLetterTemplate },
    { id: 'executive-premium-letter', name: 'Executive Premium', component: ExecutivePremiumLetterTemplate },
    { id: 'creative-modern-letter', name: 'Kreativ Modern', component: CreativeModernLetterTemplate },
    { id: 'minimalist-elegant-letter', name: 'Minimalistisch Elegant', component: MinimalistElegantLetterTemplate },
    { id: 'corporate-classic-letter', name: 'Corporate Klassisch', component: CorporateClassicLetterTemplate },
    { id: 'tech-innovation-letter', name: 'Tech Innovation', component: TechInnovationLetterTemplate }
  ],
  credit: [
    { id: 'professional-business-credit', name: 'Klassisch Professionell', component: ProfessionalBusinessCreditTemplate },
    { id: 'executive-premium-credit', name: 'Executive Premium', component: ExecutivePremiumCreditTemplate },
    { id: 'creative-modern-credit', name: 'Kreativ Modern', component: CreativeModernCreditTemplate },
    { id: 'minimalist-elegant-credit', name: 'Minimalistisch Elegant', component: MinimalistElegantCreditTemplate },
    { id: 'corporate-classic-credit', name: 'Corporate Klassisch', component: CorporateClassicCreditTemplate },
    { id: 'tech-innovation-credit', name: 'Tech Innovation', component: TechInnovationCreditTemplate }
  ],
  delivery: [
    { id: 'professional-business-delivery', name: 'Klassisch Professionell', component: ProfessionalBusinessDeliveryTemplate },
    { id: 'executive-premium-delivery', name: 'Executive Premium', component: ExecutivePremiumDeliveryTemplate },
    { id: 'creative-modern-delivery', name: 'Kreativ Modern', component: CreativeModernDeliveryTemplate },
    { id: 'minimalist-elegant-delivery', name: 'Minimalistisch Elegant', component: MinimalistElegantDeliveryTemplate },
    { id: 'corporate-classic-delivery', name: 'Corporate Klassisch', component: CorporateClassicDeliveryTemplate },
    { id: 'tech-innovation-delivery', name: 'Tech Innovation', component: TechInnovationDeliveryTemplate }
  ]
};
  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      <div className="flex gap-8">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center justify-between">
                ...
                <Badge variant="outline" className="text-sm px-3 py-1">{selectedTemplate}</Badge>
              </div>
            </div>
        ...
        </div>        {/* RECHTS: Template-Galerie - Sticky beim Seiten-Scroll */}
              ...
              >
                ...
                <div className="bg-white rounded border mb-2 h-80 relative overflow-hidden">
                  ...
                  <div className="absolute top-1 left-1 right-1 bottom-1">
                    <div className="transform scale-[0.25] origin-top-left pointer-events-none" style={{width: '400%', height: '400%'}}>
