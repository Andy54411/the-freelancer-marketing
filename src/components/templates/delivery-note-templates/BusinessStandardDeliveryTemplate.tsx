...
// DIN-orientiertes, neutrales B2B-Lieferschein-Layout (A4, druckfreundlich)
export const BusinessStandardDeliveryTemplate: React.FC<TemplateProps> = ({
  data,
  companySettings,
  customizations,
}) => {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-10 font-sans text-gray-900">
      ...
      <div className="flex items-center justify-between mb-6 pb-2 border-b border-gray-300">
        <div className="text-3xl tracking-wide font-light">Lieferschein</div>
      </div>
      ...
      {(bankLine || legalLine) && (
        <div className="mt-10 pt-4 border-t border-gray-300 text-[11px] text-gray-600">
...
export default BusinessStandardDeliveryTemplate;
