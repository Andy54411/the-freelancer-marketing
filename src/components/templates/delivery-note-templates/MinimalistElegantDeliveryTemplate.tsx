  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-10 font-sans text-gray-900">
      ...
      <div className="flex items-center justify-between mb-6 pb-2 border-b border-gray-200">
        <div className="text-3xl tracking-wide font-light text-gray-800">Lieferschein</div>
      </div>
      ...
      {/* Tabelle mit minimalem Design */}
      {data.items && data.items.length > 0 && (
        <div className="mb-10">
          <table className="w-full border-collapse">
            <thead>
              <tr className="border-b border-gray-300">
                <th className="p-3 text-left text-xs font-medium tracking-wide text-gray-600">
                  Pos.
                </th>
                <th className="p-3 text-left text-xs font-medium tracking-wide text-gray-600">
                  Art-Nr.
                ...
                <th className="p-3 text-center text-xs font-medium tracking-wide text-gray-600">
                  Menge
                </th>
                <th className="p-3 text-center text-xs font-medium tracking-wide text-gray-600">
                  Einheit
      ...
      {/* Footer mit minimalem Design */}
      <div className="mt-10 pt-4 border-t border-gray-200 text-xs text-gray-600">
        <div className="text-center">
          <div className="text-gray-700 font-medium">Minimalist Elegant • Zeitlose Eleganz</div>
          <div className="mt-2">
...
export default MinimalistElegantDeliveryTemplate;
