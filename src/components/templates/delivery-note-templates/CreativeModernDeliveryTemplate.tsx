...
export const CreativeModernDeliveryTemplate: React.FC<TemplateProps> = ({
  ...
  return (
    <div className="max-w-4xl mx-auto bg-white p-10 font-sans text-gray-900">
      ...
      {/* Titel */}
      <div className="flex items-center justify-between mb-6 pb-2 border-b border-red-300">
        <div className="text-3xl tracking-wide font-light text-red-800">Lieferschein</div>
      </div>
          ...
          <table className="w-full border-collapse">
            ...
            <tbody>
              {data.items.map((item, idx) => {
                ...
                return (
                  <tr key={idx} className="border-b border-gray-200 align-top hover:bg-red-50">
      ...
      {/* Footer mit rotem Akzent */}
      <div className="mt-10 pt-4 border-t border-red-300 text-xs text-gray-600">
        <div className="text-center">
          <div className="text-red-700 font-medium">Creative Modern • Innovative Lösungen</div>
          <div className="mt-2">
...
export default CreativeModernDeliveryTemplate;
