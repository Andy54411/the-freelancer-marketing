...
export const ExecutivePremiumOrderTemplate: React.FC<TemplateProps> = ({ 
  data, 
  companySettings,
  customizations 
}) => {
        ...
        <div className="relative z-10">
          <div className="flex justify-between items-start">
            <div className="flex-1">
              ...
              <h2 className="text-3xl font-bold text-gold-400">ORDER CONFIRMATION</h2>
              <p className="text-xl text-gray-300 mt-2">Order ID: {data.documentNumber}</p>
            </div>
      ...
      <div className="p-8">
        ...
        <div className="mb-8">
          <div className="bg-gradient-to-r from-yellow-50 to-amber-50 p-8 rounded-lg border-l-4 border-yellow-500">
            <h3 className="text-2xl font-bold text-gray-800 mb-4">Executive Order Confirmed</h3>
            <p className="text-gray-700 text-lg leading-relaxed">
              We are honored to confirm your executive order. Your premium service request has been 
              received and assigned to our dedicated executive team for priority processing. Every 
              detail will be handled with the utmost care and attention to excellence.
            </p>
          </div>
        </div>

        {/* Distinguished Client & Order Details */}
        <div className="grid grid-cols-3 gap-6 mb-8">
          ...
          <div className="space-y-4">
            <div className="bg-gradient-to-br from-gray-800 to-gray-900 text-white p-4 rounded-lg">
              <h4 className="font-semibold text-yellow-400 mb-2">Order Date</h4>
            ...
            <div className="bg-gradient-to-br from-yellow-500 to-amber-600 text-white p-4 rounded-lg">
              <h4 className="font-semibold mb-2">Executive Delivery</h4>
              <p className="text-xl font-bold">{data.validUntil || 'Priority'}</p>
            </div>
          </div>
        </div>
            ...
            <table className="w-full">
              <thead className="bg-gradient-to-r from-gray-800 via-gray-900 to-black text-white">
                <tr>
                  ...
                  <th className="p-5 text-right font-semibold">Unit Price</th>
        ...
        <div className="flex justify-end mb-8">
          <div className="w-96">
            <div className="bg-gradient-to-br from-gray-800 to-black text-white rounded-t-lg p-6">
              <h4 className="font-bold text-2xl text-yellow-400">Executive Summary</h4>
            </div>
        ...
        <div className="grid grid-cols-2 gap-8 mb-8">
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 p-6 rounded-lg border border-gray-200">
            <h4 className="font-bold text-gray-800 mb-4 text-lg">Executive Service Promise</h4>
          ...
          <div className="bg-gradient-to-br from-yellow-50 to-amber-50 p-6 rounded-lg border border-yellow-200">
            <h4 className="font-bold text-amber-800 mb-4 text-lg">Exclusive Benefits</h4>
            <ul className="text-amber-700 space-y-3">
              ...
              <li className="flex items-center">
                <span className="w-2 h-2 bg-amber-500 rounded-full mr-3"></span>
                Exclusive executive events access
              </li>
              <li className="flex items-center">
                <span className="w-2 h-2 bg-amber-500 rounded-full mr-3"></span>
        ...
        <div className="border-t-2 border-gray-800 pt-8">
          ...
          <div className="text-center bg-gradient-to-r from-gray-800 to-black text-white p-6 rounded-lg">
            <p className="text-2xl font-light text-yellow-400 mb-2">
              Executive Partnership Confirmed
            </p>
            <p className="text-gray-300">
              Your trust in our executive services is deeply appreciated
            </p>
          </div>
        </div>
      </div>
