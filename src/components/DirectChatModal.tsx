                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-3">
                    {messages.length === 0 ? (
                        ...
                        messages.map((message) => (
                            ...
                            >
                                <div
                                    className={`max-w-xs lg:max-w-md px-3 py-2 rounded-lg ${message.senderId === user?.uid
                                            ? 'bg-[#14ad9f] text-white'
                                            : 'bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white'
                                        }`}
                                >
                                    <p className="text-sm">{message.text}</p>
                                    <p className={`text-xs mt-1 ${message.senderId === user?.uid ? 'text-teal-100' : 'text-gray-500 dark:text-gray-400'
                                        }`}>
