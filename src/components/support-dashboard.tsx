              ...
              {escalations.length === 0 ? (
                ...
                <div className="space-y-4">
                  {escalations.map(escalation => (
                    <div key={escalation.id} className="border rounded-lg p-4 hover:bg-gray-50">
                      <div className="flex items-start justify-between">
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-gray-600 mb-2">{escalation.customerEmail}</p>
          ...
          <Card>
            ...
            <CardContent>
              {activeSessions.length === 0 ? (
                <p className="text-gray-500 text-center py-8">Keine aktiven Chat-Sessions.</p>
              ) : (
                <div className="space-y-4">
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-600">
                          <span>⏱️ Ø {Math.round(question.avgResolutionTime)}s</span>
                          <span>📈 {Math.round(question.escalationRate * 100)}% Eskalation</span>
                          <span>🕒 Zuletzt: {formatTime(question.lastAsked)}</span>
                        </div>
                      </div>
                    </div>
                  </div>
