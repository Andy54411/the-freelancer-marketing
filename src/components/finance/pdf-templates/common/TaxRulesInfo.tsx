...
export const TaxRulesInfo: React.FC<TaxRulesInfoProps> = ({ data, color, language = 'de' }) => {
  ...
  const taxRuleLabels = {
    ...
    'en': {
      'DE_TAXABLE': 'Taxable revenue (standard rate 19%, § 1 para. 1 no. 1 in conjunction with § 12 para. 1 VAT Act)',
      ...
      'EU_REVERSE_18B': 'Reverse charge – Tax liability of the service recipient (Art. 196 VAT Directive, § 18b VAT Act)',
      'EU_INTRACOMMUNITY_SUPPLY': 'Intra-Community supply, tax-exempt according to § 4 No. 1b in conjunction with § 6a VAT Act',
      ...
      'NON_EU_OUT_OF_SCOPE': 'Service not taxable in Germany (place of service outside Germany, § 3a para. 2 VAT Act)'
    }
  };
