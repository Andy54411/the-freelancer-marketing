...
export const GeometricTemplate: React.FC<GeometricTemplateProps> = ({
  ...
  return (
    <div className="bg-white w-full max-w-[210mm] mx-auto text-xs" style={{ fontFamily: 'Arial, sans-serif' }}>
      ...
      <div className="pdf-page flex flex-col">
        ...
        <div className="p-6 pb-4">
          ...
          <div className="grid grid-cols-2 gap-8 mb-8">
            <div>
              <div className="font-semibold mb-3" style={{ color }}>Rechnungsempfänger</div>
            ...
            <div>
              <div className="font-semibold mb-3" style={{ color }}>Rechnungsdetails</div>
              <div className="space-y-2">
      ...
      >
        ...
        <div className="px-6 flex-1">
          ...
          <div className="flex justify-between items-start gap-8 mb-8">
            <div className="flex-1">
              <div className="p-4 border-l-4 bg-gradient-to-r from-blue-50 to-white" style={{ borderColor: color }}>
          ...
          {data.notes && (
            <div className="mt-4 p-4 bg-yellow-50 border-l-4 border-yellow-400 rounded-r">
              <div className="font-medium text-yellow-800 mb-2">Hinweise</div>
