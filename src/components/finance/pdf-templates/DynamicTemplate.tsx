...
export const DynamicTemplate: React.FC<DynamicTemplateProps> = ({
  ...
  return (
    <div className="bg-white w-full max-w-[210mm] mx-auto text-xs overflow-hidden relative" style={{ fontFamily: 'Arial, sans-serif' }}>
      ...
      <div className="pdf-page flex flex-col dynamic-bg">
        ...
        <div className="dynamic-shape" style={{ width: '200px', height: '200px', top: '-50px', right: '-50px', opacity: 0.1 }} />
        <div className="dynamic-shape" style={{ width: '100px', height: '100px', top: '100px', left: '-30px', opacity: 0.08 }} />
        <div className="dynamic-shape" style={{ width: '150px', height: '150px', bottom: '50px', right: '20px', opacity: 0.06 }} />
        ...
        <div className="p-6 pb-4 relative z-10">
            ...
            <div className="flex justify-between items-start mb-6">
              <div className="flex-1">
                ...
                <div className="mt-2 ml-4">
                  <div className="text-lg font-semibold" style={{ color }}>{data.documentLabel}</div>
              ...
              <div className="flex-shrink-0">
                {data.companyLogo && (
                  <div className="relative">
                    <div className="absolute inset-0 rounded-full" style={{ backgroundColor: color, opacity: 0.1 }} />
                    <img
          ...
          <div className="grid grid-cols-2 gap-8 mb-8">
            <div className="bg-white/70 backdrop-blur-sm p-4 rounded-lg border-l-4" style={{ borderColor: color }}>
              <div className="font-semibold mb-3 text-lg" style={{ color }}>Rechnungsempfänger</div>
            ...
            <div className="bg-white/70 backdrop-blur-sm p-4 rounded-lg border-l-4" style={{ borderColor: color }}>
              <div className="font-semibold mb-3 text-lg" style={{ color }}>Rechnungsdetails</div>
              <div className="space-y-2">
                <div><span className="font-medium">Datum:</span> {formatDate(data.invoiceDate)}</div>
                <div><span className="font-medium">Fälligkeitsdatum:</span> {formatDate(data.dueDate)}</div>
                <div><span className="font-medium">Zahlungsziel:</span> {data.paymentTerms}</div>
              </div>
            </div>
          </div>
      ...
      >
        ...
        <div className="dynamic-shape" style={{ width: '180px', height: '180px', top: '-40px', left: '-40px', opacity: 0.08 }} />
        <div className="dynamic-shape" style={{ width: '120px', height: '120px', top: '80px', right: '-20px', opacity: 0.06 }} />
        <div className="dynamic-shape" style={{ width: '90px', height: '90px', bottom: '100px', left: '30px', opacity: 0.04 }} />
        ...
        <div className="px-6 flex-1 relative z-10">
          ...
          <div className="flex justify-between items-start gap-8 mb-8">
            <div className="flex-1">
              <div className="bg-white/80 backdrop-blur-sm p-4 rounded-lg border-l-4" style={{ borderColor: color }}>
          ...
          {data.notes && (
            <div className="mt-4 bg-white/80 backdrop-blur-sm p-4 rounded-lg border-l-4" style={{ borderColor: color }}>
