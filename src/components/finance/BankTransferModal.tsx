    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl max-w-4xl w-full mx-4 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <h1 className="text-xl font-semibold text-gray-900">Überweisung tätigen</h1>
          <button
            onClick={onClose}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
                ...
                <div
                  ...
                  title="Überweisungen können nur mit einem Online Zahlungskonto durchgeführt werden."
                >
                ...
                >
                  ...
                  {invoices.map(invoice => (
                    <option key={invoice.id} value={invoice.id}>
                      {invoice.documentNumber} - {invoice.customerName} -{' '}
                      {invoice.remainingAmount?.toFixed(2) || invoice.total.toFixed(2)}€
                ...
                >
                  ...
                  {expenses.map(expense => (
                    <option key={expense.id} value={expense.id}>
                      {expense.documentNumber} - {expense.supplierName} -{' '}
                      {expense.remainingAmount?.toFixed(2) || expense.total.toFixed(2)}€
                    ...
                    <input
                      ...
                      onChange={e => {
                        ...
                        if (
                          ...
                          e.target.value !== formData.selectedContact.name
                        ) {
                          setFormData({
                            ...formData,
                            selectedContact: null,
                      ...
                      filteredContacts.map(contact => (
                        ...
                        >
                          <div className="flex items-center justify-between">
                            ...
                            {contact.iban && (
                              <div className="text-xs text-gray-400">{contact.iban.slice(-4)}</div>
                            )}
                          </div>
                        </button>
                      ))
                    ) : (
                      <div className="px-4 py-3 text-sm text-gray-500">Keine Kontakte gefunden</div>
                    )}
                  </div>
                )}
        ...
        <div className="flex justify-end gap-3 p-6 border-t border-gray-200">
          ...
          <button
            ...
            className="px-4 py-2 text-sm font-medium text-white bg-[#14ad9f] rounded-md hover:bg-taskilo-hover disabled:opacity-50 disabled:cursor-not-allowed"
          >
