                      ...
                      <div key={invoice.id} className="border rounded-lg p-3 hover:bg-gray-50">
                        <div className="flex items-center justify-between mb-2">
                          <div className="flex items-center gap-2">
                            ...
                            <Badge 
                              variant={InvoiceStatusHelper.getStatusColor(invoice.status) === 'green' ? 'default' : 'secondary'}
                              className={
                        ...
                        <div className="text-sm text-gray-600 space-y-1">
                          ...
                          {invoice.dueDate && (
                            <div>
                              <span className="font-medium">Fällig:</span> {formatDate(invoice.dueDate)}
                            </div>
                          )}
                          {invoice.description && (
                            <div>
                          ...
                          {invoice.isStorno && invoice.originalInvoiceId && (
                            <div className="text-red-600">
                              <span className="font-medium">Storno von:</span> {invoice.originalInvoiceId}
                            </div>
                          )}
                        </div>
                      </div>
