          ...
          <div className="space-y-4">
            ...
            <div className="relative">
              {editedItem.imageUrl ? (
                ...
                <button
                  onClick={() => fileInputRef.current?.click()}
                  className="w-full h-64 border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center hover:border-[#14ad9f] transition-colors"
                >
                ...
                <div className="relative">
                  ...
                  >
                    <span className={selectedSubcategory ? 'text-gray-900' : 'text-gray-500'}>
                      {selectedSubcategory || (selectedCategory ? 'Subkategorie wählen' : 'Erst Hauptkategorie wählen')}
                    </span>
                    <ChevronDown className={`w-4 h-4 transition-transform ${subcategoryDropdownOpen ? 'rotate-180' : ''} ${!selectedCategory ? 'text-gray-400' : ''}`} />
                  </button>
            ...
            <div className="flex items-center">
              <label className="flex items-center cursor-pointer">
                ...
                <div className={`relative w-5 h-5 rounded border-2 transition-colors ${
                  ...
                  {editedItem.featured && (
                    <Star className="w-3 h-3 text-white absolute top-0.5 left-0.5" fill="currentColor" />
                  )}
                </div>
