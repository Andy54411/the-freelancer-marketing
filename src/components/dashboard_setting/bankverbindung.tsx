  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-lg shadow-sm p-6 space-y-6">
      <div className="grid md:grid-cols-2 gap-6">
        <div>
          <label className="block mb-1 font-medium text-gray-900 dark:text-gray-200">Kontoinhaber</label>
          <input
            type="text"
        ...
        <div>
          <label className="block mb-1 font-medium text-gray-900 dark:text-gray-200">Bankname</label>
          <input
            type="text"
