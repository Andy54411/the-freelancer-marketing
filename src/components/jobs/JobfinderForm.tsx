  ...
  return (
    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
      ...
      <div className="bg-teal-50 border border-teal-100 rounded-lg p-4 text-sm text-teal-900">
        ...
        <p>
          Ort: <span className="font-medium">{watchedLocation || 'Kein Ort'}</span>
        </p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="flex gap-4 items-end">
          ...
          <div className="w-40 space-y-2">
            ...
            <Select defaultValue="20" onValueChange={val => form.setValue('radius', val)}>
              <SelectTrigger>
      ...
      {/* Salary Section */}
      <div className="space-y-4">
        <h3 className="text-lg font-semibold text-gray-900 border-b pb-2">Gehaltswunsch</h3>
        <div className="space-y-2">
          <Label htmlFor="salary">Jahresgehalt (Brutto) ab</Label>
          <div className="relative">
          ...
          <p className="text-xs text-gray-500">Geben Sie Ihr gewünschtes Mindestjahresgehalt an.</p>
        </div>
      </div>
        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-top-4 duration-300">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-500">
              Hinweis: Du kannst entweder mithilfe eines Suchbegriffs oder einer Berufsgruppe
              suchen. Eine Kombination ist nicht möglich.
            </p>
            <div className="relative">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {CATEGORIES.map(item => (
                <div key={item.id} className="flex items-center gap-2">
                  ...
                  />
                  <label htmlFor={`cat-${item.id}`} className="text-sm text-gray-700">
                    {item.label}
                  </label>
                </div>
              ))}
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {MICHELIN.map(item => (
                <div key={item.id} className="flex items-center gap-2">
                  ...
                  />
                  <label htmlFor={`mich-${item.id}`} className="text-sm text-gray-700">
                    {item.label}
                  </label>
                </div>
              ))}
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {GAULT_MILLAU.map(item => (
                <div key={item.id} className="flex items-center gap-2">
                  ...
                  />
                  <label htmlFor={`gm-${item.id}`} className="text-sm text-gray-700">
                    {item.label}
                  </label>
                </div>
              ))}
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {RANKS.map(item => (
                <div key={item.id} className="flex items-center gap-2">
                  ...
                  />
                  <label htmlFor={`rank-${item.id}`} className="text-sm text-gray-700">
                    {item.label}
                  </label>
                </div>
              ))}
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
              {EMPLOYMENT_TYPES.map(item => (
                <div key={item.id} className="flex items-center gap-2">
                  ...
                  />
                  <label htmlFor={`emp-${item.id}`} className="text-sm text-gray-700">
                    {item.label}
                  </label>
                </div>
              ))}
            ...
            >
              {LANGUAGES.map(item => (
                <div key={item.id} className="flex items-center gap-2">
                  ...
                  <label htmlFor={`lang-${item.id}`} className="text-sm text-gray-700">
                    {item.label}
                  </label>
                </div>
              ))}
      ...
      <div className="flex justify-end pt-6 border-t">
        <Button
          ...
          className="bg-[#14ad9f] hover:bg-[#11968a] text-white"
        >
