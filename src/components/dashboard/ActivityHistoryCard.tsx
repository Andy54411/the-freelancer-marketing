...
export default function ActivityHistoryCard({
  ...
  useEffect(() => {
    ...
    console.log('🔄 ActivityHistoryCard: Loading activities for company:', activeCompanyId);
  ...
  const loadCustomerActivities = async () => {
    ...
    try {
      ...
      console.log('👥 ActivityHistoryCard: Found', customersSnapshot.size, 'customers');
      ...
      for (const customerDoc of customersSnapshot.docs) {
        ...
        try {
          ...
          console.log(`📊 ActivityHistoryCard: Customer ${customerName} has ${activitiesSnapshot.size} activities`);
      ...
      console.log('✅ ActivityHistoryCard: Loaded total', allActivities.length, 'activities');
