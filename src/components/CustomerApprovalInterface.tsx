                    ...
                    <div className="p-6">
                        <div className="space-y-3">
                            {request.timeEntries.map(entry => (
                                <div
                                    key={entry.id}
                                    className={`p-4 rounded-lg border-2 transition-all cursor-pointer ${selectedEntries.has(entry.id!)
                                ...
                                >
                                    <div className="flex items-start justify-between">
                                        ...
                                        <div className="ml-4">
                                            <div
                                                className={`w-5 h-5 rounded border-2 flex items-center justify-center ${selectedEntries.has(entry.id!)
