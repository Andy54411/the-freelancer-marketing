    ...
    <div className="mt-6">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-[#14ad9f] capitalize font-medium">
              {editingPackageType} Paket bearbeiten
            </p>
          </div>
        </div>
        <Button
      ...
      {isLoading ? (
        <div className="bg-[#14ad9f]/5 border border-[#14ad9f]/20 rounded-lg p-3 mb-6">
          <p className="text-sm text-[#14ad9f]">⏳ Lade Daten aus Firestore...</p>
        </div>
      ) : currentPackage ? (
        <div className="bg-[#14ad9f]/5 border border-[#14ad9f]/20 rounded-lg p-3 mb-6">
          <p className="text-sm text-[#14ad9f]">
            ✅ Daten geladen • Preis: {currentPackage.price}€ • {addons.length} Zusatzleistungen •
      ...
      <div className="border rounded-lg p-6 bg-white shadow-sm mb-4 border-[#14ad9f]/20">
        <h4 className="text-lg font-semibold text-[#14ad9f] mb-4">Paket-Details</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div>
              ...
              <div className="relative">
                ...
                <span className="absolute right-3 top-1/2 transform -translate-y-1/2 text-[#14ad9f] text-sm font-medium">
                  €
                </span>
              </div>
            </div>
            ...
            <div>
              <Label className="text-sm font-medium text-[#14ad9f] mb-1 block">Einheit</Label>
              <Select
          ...
          {addons.map((addon, index) => (
            <div key={index} className="border rounded-lg p-4 bg-[#14ad9f]/5 border-[#14ad9f]/20">
              ...
              <div className="grid gap-3">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  <div>
                    <Label
                      ...
                      className="text-sm font-medium text-[#14ad9f] mb-1 block"
                    >
                      Name
                    </Label>
                    <Input
                ...
                <div>
                  <Label
                    htmlFor={`addon-description-${index}`}
                    className="text-sm font-medium text-[#14ad9f] mb-1 block"
                  >
                    Beschreibung
                  </Label>
