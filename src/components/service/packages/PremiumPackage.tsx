...
import { Star, Clock, Euro, Crown, RotateCcw } from 'lucide-react';
...
interface PremiumPackageProps {
  ...
  onUpdate: (data: Partial<PremiumPackageProps['formData']>) => void;
}
      ...
      <CardHeader>
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <Crown className="h-5 w-5 text-[#14ad9f]" />
            <CardTitle className="text-[#14ad9f]">Premium Paket</CardTitle>
      ...
      {isActive && (
        <CardContent className="space-y-4">
          ...
          <div className="flex items-center space-x-2 p-3 bg-gray-50 rounded-lg">
            <Checkbox
              id="duration-enabled-premium"
              checked={formData.hasDuration}
              onCheckedChange={checked => onUpdate({ hasDuration: !!checked })}
            />
            <label htmlFor="duration-enabled-premium" className="text-sm font-medium text-gray-700">
          ...
          >
            ...
            {needsRevisions && (
              <div className="space-y-2">
                ...
                <Input
                  type="number"
                  value={formData.revisions || getDefaultRevisions('premium')}
          ...
          <div className="space-y-2">
            ...
            <Textarea
              ...
              placeholder="Beschreiben Sie was in diesem Premium-Paket enthalten ist..."
              rows={3}
              className="focus:ring-[#14ad9f] focus:border-[#14ad9f]"
            />
          </div>
