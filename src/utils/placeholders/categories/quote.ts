...
export const quotePlaceholders: PlaceholderRegistry = {
  ...
  // Projektbezug
  'ANGEBOT_PROJEKTNAME': (context: PlaceholderContext) => 
    context.quote?.projectName || '',
    
  'ANGEBOT_PROJEKTBESCHREIBUNG': (context: PlaceholderContext) => 
    context.quote?.projectDescription || '',
  
  // Zahlungskonditionen
  'ANGEBOT_ZAHLUNGSBEDINGUNGEN': (context: PlaceholderContext) => 
    context.quote?.paymentTerms || '',
    
  'ANGEBOT_LIEFERBEDINGUNGEN': (context: PlaceholderContext) => 
    context.quote?.deliveryTerms || '',
  ...
  'ANGEBOT_BEDINGUNGEN': (context: PlaceholderContext) => 
    context.quote?.conditions || '',
};
