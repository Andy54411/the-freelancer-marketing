...
export const companyPlaceholders: PlaceholderRegistry = {
  ...
  FIRMENSTRASSE: (context: PlaceholderContext) => context.company?.street || '',

  FIRMENPLZ: (context: PlaceholderContext) => context.company?.postalCode || '',

  FIRMENORT: (context: PlaceholderContext) => context.company?.city || '',

  FIRMENLAND: (context: PlaceholderContext) => context.company?.country || '',

  // Kontakt-Informationen
  FIRMENTELEFON: (context: PlaceholderContext) => context.company?.phone || '',

  FIRMENEMAIL: (context: PlaceholderContext) => context.company?.email || '',

  FIRMENFAX: (context: PlaceholderContext) => context.company?.fax || '',

  FIRMENWEBSITE: (context: PlaceholderContext) => context.company?.website || '',
  ...
  HANDELSREGISTER: (context: PlaceholderContext) => context.company?.commercialRegister || '',

  AMTSGERICHT: (context: PlaceholderContext) => context.company?.court || '',

  RECHTSFORM: (context: PlaceholderContext) => context.company?.legalForm || '',

  // Zusätzliche Firmen-Felder
  FIRMENBESCHREIBUNG: (context: PlaceholderContext) => context.company?.description || '',

  BRANCHE: (context: PlaceholderContext) => context.company?.industry || '',
  ...
  FIRMENLOGO: (context: PlaceholderContext) => context.company?.logoUrl || '',

  FIRMENFARBE: (context: PlaceholderContext) => context.company?.brandColor || '',
