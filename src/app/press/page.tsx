      ...
      <div className="min-h-screen bg-gray-50">
        ...
        <div className="bg-[#14ad9f] text-white py-16">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <p className="text-xl opacity-90">Informationen und Ressourcen für Medienvertreter</p>
          </div>
        </div>
            ...
            <section>
              ...
              <div className="bg-white rounded-lg shadow-md p-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  qualifizierte Dienstleister in ihrer Nähe finden, während Dienstleister neue
                  Kunden gewinnen und ihr Geschäft ausbauen können.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-lg shadow-md p-6 text-center">
                  ...
                  <p className="text-gray-600">Moderne Technologie für einfache Vermittlung</p>
                </div>
              </div>
            </section>
