            ...
            <div className="max-w-4xl mx-auto px-4 py-12">
                <div className="space-y-8">
                    ...
                    <section className="bg-gray-100 rounded-lg p-8">
                        <h3 className="text-lg font-semibold text-gray-900 mb-4">Browser-Einstellungen für Cookies</h3>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            <div>
                                <h4 className="font-medium mb-2">Chrome</h4>
                                <p className="text-gray-600">Einstellungen → Erweitert → Datenschutz und Sicherheit → Cookies</p>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <p className="text-gray-600">Einstellungen → Datenschutz → Cookies und Website-Daten</p>
                            </div>
                            <div>
