            ...
            <div className="space-y-8">
              ...
              <section className="bg-white/10 backdrop-blur-sm rounded-lg p-8">
                ...
                <p className="text-white/90 drop-shadow-lg leading-relaxed mb-4">
                  ...
                  unsere Website besuchen. Sie helfen uns dabei, Ihre Präferenzen zu speichern und
              ...
              <section className="bg-white/10 backdrop-blur-sm rounded-lg p-8">
                ...
                <div className="space-y-6">
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded p-4 text-sm space-y-3">
                      <div>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>__session</strong>: Firebase Authentication Session Cookie
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Zweck:</strong> Benutzerauthentifizierung und Sitzungsverwaltung
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Laufzeit:</strong> 2 Wochen
                        </p>
                      </div>
                      <div>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>firebase:authUser</strong>: Firebase Auth User Data
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Zweck:</strong> Speicherung von Benutzerdaten im Local Storage
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Laufzeit:</strong> Bis zur Abmeldung
                        </p>
                      </div>
                      <div>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>firebase:host</strong>: Firebase Storage Cache
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Zweck:</strong> Caching für Firebase Storage und Firestore
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Laufzeit:</strong> 30 Tage
                        </p>
                      </div>
                    </div>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-white drop-shadow-lg mb-2">
                      2. Google Tag Manager und Analytics Cookies
                    </h3>
                    <p className="text-white/90 drop-shadow-lg mb-3">
                      Diese Cookies werden von Google Tag Manager und Google Analytics verwendet, um
                      das Nutzerverhalten zu analysieren und die Website zu verbessern. Sie werden
                      nur mit Ihrer Zustimmung gesetzt.
                    </p>
                    <div className="bg-white/10 backdrop-blur-sm rounded p-4 text-sm space-y-3">
                      <div>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>_ga</strong>: Google Analytics Cookie
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Zweck:</strong> Eindeutige Benutzer-ID für Webseitenanalyse
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                      ...
                      <div>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>_ga_*</strong>: Google Analytics 4 Cookie
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Zweck:</strong> Sitzungsstatus und Ereignisverfolgung
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Laufzeit:</strong> 2 Jahre
                        </p>
                      ...
                      <div>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>_gid</strong>: Google Analytics Cookie
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Zweck:</strong> Kurzzeitige Benutzer-ID für Webseitenanalyse
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Laufzeit:</strong> 24 Stunden
                        </p>
                      </div>
                      <div>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>_gtm_*</strong>: Google Tag Manager Cookie
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Zweck:</strong> Verwaltung von Tracking-Tags und Analytics
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                      ...
                      <div>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>analytics_consent</strong>: DSGVO Analytics Consent
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Zweck:</strong> Speicherung der Analytics-Zustimmung
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                      ...
                      <div>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>marketing_consent</strong>: DSGVO Marketing Consent
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Zweck:</strong> Speicherung der Marketing-Zustimmung
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Laufzeit:</strong> 1 Jahr
                        </p>
                      ...
                      <div>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>taskilo-cookie-consent</strong>: Cookie Consent Status
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Zweck:</strong> Speicherung aller Cookie-Zustimmungen
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Laufzeit:</strong> 1 Jahr
                        </p>
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white drop-shadow-lg mb-2">
                      4. Performance und Hosting Cookies
                    </h3>
                    <p className="text-white/90 drop-shadow-lg mb-3">
                      Diese Cookies werden für Website-Performance und Hosting-Optimierung
                      verwendet.
                    </p>
                    <div className="bg-white/10 backdrop-blur-sm rounded p-4 text-sm space-y-3">
                      <div>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>__vercel_analytics_id</strong>: Vercel Analytics Cookie
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Zweck:</strong> Anonyme Webseitenanalyse und
                      ...
                      <div>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>PHPSESSID</strong>: Siteground Hosting Session Cookie
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Zweck:</strong> Session-Management für PHP-basierte Funktionen
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Laufzeit:</strong> Session (wird beim Schließen des Browsers
                          gelöscht)
                        </p>
                      </div>
                      <div>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>siteground_security_*</strong>: Siteground Security Cookies
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Zweck:</strong> Sicherheitsmaßnahmen und Schutz vor Spam/Bots
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Laufzeit:</strong> 24 Stunden
                        </p>
                      ...
                      <div>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>sg_cache_*</strong>: Siteground Cache Cookies
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Zweck:</strong> Optimierung der Website-Performance und Caching
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Laufzeit:</strong> 1 Stunde
                        </p>
                      </div>
                    </div>
                  </div>
                  <div>
                    <h3 className="text-lg font-semibold text-white drop-shadow-lg mb-2">
                      4. KI-Chatbot und Support Cookies
                    </h3>
                    <p className="text-white/90 drop-shadow-lg mb-3">
                      Diese Cookies werden für unseren KI-gestützten Chatbot und Support-System
                      verwendet.
                    </p>
                    <div className="bg-white/10 backdrop-blur-sm rounded p-4 text-sm space-y-3">
                      <div>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>chatbot_session</strong>: Chatbot Session Cookie
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Zweck:</strong> Verfolgung der Chatbot-Sitzung und
                          Gesprächsverlauf
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Laufzeit:</strong> 24 Stunden
                      ...
                      <div>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>support_chat_*</strong>: Support Chat Cookies
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Zweck:</strong> Speicherung von Support-Chat-Daten und
                          Eskalationen
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Laufzeit:</strong> Session
                      ...
                      <div>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>gemini_context</strong>: KI-Kontext Cookie
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Zweck:</strong> Speicherung des Gesprächskontexts für bessere
                          KI-Antworten
                        </p>
                        <p className="text-white/90 drop-shadow-lg">
                          <strong>Laufzeit:</strong> 1 Stunde
                  ...
                  <div>
                    ...
                    <div className="bg-white/10 backdrop-blur-sm rounded p-4 text-sm">
                      <p className="text-white/90 drop-shadow-lg">
                        <strong>googtrans</strong>: Google Translate Cookie
                      </p>
                      <p className="text-white/90 drop-shadow-lg">
                        <strong>Zweck:</strong> Speichert die gewählte Sprache für die Übersetzung
                      </p>
                      <p className="text-white/90 drop-shadow-lg">
                        <strong>Laufzeit:</strong> Session
                      </p>
              ...
              <section className="bg-white/10 backdrop-blur-sm rounded-lg p-8">
                ...
                <div className="space-y-4">
                  <p className="text-white/90 drop-shadow-lg">
                    Sie können Ihre Cookie-Einstellungen jederzeit ändern. Klicken Sie auf den
                    Button unten, um Ihre Präferenzen anzupassen.
                  </p>
                  <div className="flex justify-center">
                    <button
                      ...
                      className="bg-[#14ad9f] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#0f8b7e] transition-colors shadow-lg"
                    >
                      Cookie-Einstellungen ändern
                    </button>
                  </div>
                  <p className="text-white/90 drop-shadow-lg">
                    Sie können Cookies auch in Ihren Browser-Einstellungen verwalten. Beachten Sie
                    jedoch, dass die Deaktivierung bestimmter Cookies die Funktionalität unserer
