...
import { FiLoader, FiSave, FiUser, FiImage, FiMapPin, FiClock, FiCheckCircle, FiTrendingUp, FiZap, FiAward, FiPlus, FiEdit3, FiTrash2, FiEye, FiStar, FiShield } from 'react-icons/fi';
...
const CompanyProfileManager: React.FC<CompanyProfileManagerProps> = ({ userData, companyMetrics, onDataSaved }) => {
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                    <div className="mb-4">
                        ...
                        <p className="text-sm text-gray-600 mt-1">
                            Diese Metriken werden automatisch basierend auf Ihren tatsächlichen Aktivitäten berechnet.
                        </p>
                    </div>
                    ...
                    <div className="mt-6">
                        ...
                        <p className="text-xs text-gray-500 mt-2">
                            Badges werden automatisch vergeben basierend auf Ihrer Leistung und Kundenzufriedenheit.
                        </p>
                    </div>

                    {/* Online Status */}
                    <div className="mt-6 flex items-center gap-2">
                        <div className={`w-3 h-3 rounded-full ${companyMetrics?.isOnline ? 'bg-green-500' : 'bg-gray-400'}`}></div>
                        <span className="text-sm text-gray-700">
                            {companyMetrics?.isOnline ? 'Online' : 'Offline'}
                        </span>
                        <span className="text-xs text-gray-500">
                            (basierend auf letzter Aktivität)
                        </span>
                    </div>
                </div>
            )}
