...
import { FiLoader, FiSave, FiUser, FiImage, FiMapPin, FiClock, FiCheckCircle, FiTrendingUp, FiZap, FiAward, FiPlus, FiEdit3, FiTrash2, FiEye, FiStar } from 'react-icons/fi';
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={(e) => setProfile({...profile, completionRate: Number(e.target.value)})}
                                        className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#14ad9f] focus:border-transparent"
                                    />
                                </div>
                                <div>
                                    <label className="block text-sm font-medium text-gray-700 mb-2">Abgeschlossene Projekte</label>
                                    <input
                                        type="number"
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2 mb-3">
                                    {profile.badges.map(badge => (
                                        <span key={badge} className="bg-yellow-100 text-yellow-800 px-3 py-1 rounded-full text-sm flex items-center gap-2">
                                            {badge}
                    ...
                    {activeTab === 'portfolio' && (
                        <div className="space-y-6">
                            ...
                            <div className="bg-gray-50 p-4 rounded-lg">
                                <h4 className="font-medium text-gray-700 mb-3">Neues Portfolio-Projekt hinzufügen</h4>
                            ...
                            <div>
                                ...
                                <div className="flex flex-wrap gap-2 mb-3">
                                    {profile.skills.map(skill => (
                                        <span key={skill} className="bg-gray-200 text-gray-700 px-3 py-1 rounded-full text-sm flex items-center gap-2">
                                            {skill}
                                ...
                                <div className="space-y-2">
                                    ...
                                    <button
                                        onClick={() => {
                                            setProfile({
                                                ...profile,
                                                languages: [...profile.languages, { language: '', proficiency: 'Grundkenntnisse' }]
                                            });
                                        }}
                            ...
                            <div className="border rounded-lg p-6 bg-gray-50">
                                <div className="flex items-center gap-4 mb-4">
                                    <div className="relative w-16 h-16">
                                        ...
                                        />
                                        {profile.isOnline && <span className="absolute bottom-0 right-0 w-4 h-4 bg-green-500 rounded-full border-2 border-white"></span>}
                                    </div>
                                    <div>
                                        ...
                                        <div className="flex gap-1 mt-1">
                                            {profile.badges.map(badge => (
                                                <span key={badge} className="bg-yellow-100 text-yellow-800 text-xs px-2 py-1 rounded-full">
                                                    {badge}
                                                </span>
                                            ))}
                                        </div>
