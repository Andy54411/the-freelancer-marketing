...
'@/utils/placeholders';
import RecurringInvoiceSettings from '@/components/finance/RecurringInvoiceSettings';
  ...
  return (
    <>
      ...
      <div className="min-h-full bg-white">
        ...
        <div className="flex items-center justify-between py-4 border-b border-gray-200">
          ...
          <div className="flex items-center">
            <div>
              <h2 className="text-2xl font-bold text-gray-900">Neue Wiederkehrende Rechnung</h2>
              <p className="text-sm text-gray-600 mt-1">Erstellen Sie eine Abo-Rechnung für regelmäßige Leistungen</p>
            </div>
          </div>
      ...
      <RecurringInvoiceSettings
        ...
        onAutoGenerateChange={setRecurringAutoGenerate}
        ...
        onAutoSendEmailChange={setRecurringAutoSendEmail}
