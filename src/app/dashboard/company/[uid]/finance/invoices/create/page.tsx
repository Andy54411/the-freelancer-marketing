...
export default function CreateQuotePage() {
  ...
  const handleValidUntilChange = useCallback((newValidUntil: string) => {
    ...
    if (diffDays > 0) {
      ...
      // Negatives Datum: nur validUntil setzen, paymentDays auf 0
      setPaymentDays(0);
      setFormData((prev) => ({
        ...prev,
        validUntil: newValidUntil,
  ...
  const buildPreviewData = (): PreviewTemplateData => {
    ...
    const basePaymentTerms = formData.paymentTerms?.trim() || `Zahlbar binnen ${paymentDays} Tagen ohne Abzug`;
    ...
    const data: PreviewTemplateData = {
      ...
      customerOrderNumber: formData.customerOrderNumber || undefined, // Für Template-Kompatibilität
      currency:
      formData.currency ||
