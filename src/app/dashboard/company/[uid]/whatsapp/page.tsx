...
import { MessageCircle, Send, Search, Phone, User, Loader2, Settings, CheckCircle2 } from 'lucide-react';
...
export default function WhatsAppPage() {
  ...
  const handleInitiateConnection = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.details || errorData.error || 'Fehler beim Starten der Verbindung');
      }
  ...
  const loadMessages = async () => {
    ...
    try {
      const customerMessages = await WhatsAppService.getCustomerMessages(
        uid,
        selectedCustomer.id
      );
            ...
            <CardContent className="p-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-8">
                  Verbinde deine WhatsApp Business Nummer und schreibe direkt aus Taskilo mit deinen Kunden
                </p>
                ...
                <div className="max-w-sm mx-auto">
                  ...
                  <div className="mt-6 p-4 bg-blue-50 rounded-lg border border-blue-200">
                    <p className="text-xs text-blue-900 font-semibold mb-2">Was passiert als nächstes?</p>
                  ...
                  <div className="mt-4 p-3 bg-green-50 rounded-lg border border-green-200">
                    <p className="text-xs text-green-900">
                      <span className="font-semibold">✓ Deine eigene Nummer:</span> Kunden sehen DEINE WhatsApp Business Nummer
                    </p>
                    <p className="text-xs text-green-900 mt-1">
                      <span className="font-semibold">✓ Kostenlos:</span> Erste 1.000 Konversationen/Monat gratis
                    </p>
                  </div>
                </div>
              </div>
          ...
          {filteredCustomers.length === 0 ? (
            <div className="p-6 text-center text-gray-500">
              ...
              <p className="text-xs mt-1">
                Füge Telefonnummern zu deinen Kunden hinzu
              </p>
            </div>
          ) : (
                ...
                messages.map((message) => (
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {message.createdAt && new Date(message.createdAt).toLocaleString('de-DE', {
                          day: '2-digit',
                          month: '2-digit',
                          hour: '2-digit',
                          minute: '2-digit',
          ...
          <div className="flex-1 flex items-center justify-center bg-gray-50">
            <div className="text-center">
              ...
              <p className="text-gray-500 mb-4">
                Wähle einen Kontakt um zu chatten
              </p>
              <p className="text-sm text-gray-400">
                {customers.length} Kontakte verfügbar
              </p>
            </div>
          </div>
        )}
