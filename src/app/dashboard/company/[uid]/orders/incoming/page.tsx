  ...
  if (isLoading) {
    return (
      <div className="flex flex-col items-center justify-center py-12">
        ...
        <p className="text-gray-600">Lade eingegangene Aufträge...</p>
      </div>
    );
  }
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-lg shadow p-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Eingegangene Aufträge</h1>
            <p className="text-gray-600 mt-1">
              Aufträge, die bei Ihrem Unternehmen eingegangen sind
            </p>
          </div>
        ...
        <div className="bg-white rounded-lg shadow p-8 text-center">
          ...
          <p className="text-gray-600">
            {searchTerm
              ...
              : 'Sie haben noch keine eingegangenen Aufträge.'}
          </p>
        </div>
      ) : (
