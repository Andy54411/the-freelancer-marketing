...
interface ProviderBookingModalProps {
    ...
    onClose: () => void;
    provider: Provider;
    onConfirm: (selection: any, time: string, durationString: string, description: string) => Promise<void>;
}
...
export const ProviderBookingModal: React.FC<ProviderBookingModalProps> = ({
    ...
    const getProfileImage = () => provider.profilePictureFirebaseUrl || provider.profilePictureURL || provider.photoURL || '/images/default-avatar.jpg';
