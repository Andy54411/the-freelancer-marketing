    ...
    <form onSubmit={handleSubmit} className="space-y-6 bg-white p-6 rounded-lg shadow">
      <div>
        ...
        <p className="mt-2 text-xs text-gray-500">
          Beschreibe, wer der Chatbot ist (z.B. &ldquo;Du bist Taskilo-GPT, ein freundlicher und
          kompetenter Support-Assistent...&rdquo;).
        </p>
      </div>
      ...
      <div>
        ...
        />
        <p className="mt-2 text-xs text-gray-500">
          Grundlegende Informationen über Taskilo, die der Bot kennen muss.
        </p>
      </div>

      <div>
        <label htmlFor="faqs" className="block text-sm font-medium text-gray-700">
          Häufig gestellte Fragen (FAQs) - im JSON-Format
        </label>
        <textarea
          name="faqs"
          id="faqs"
          ...
          className="font-mono mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
        />
        <p className="mt-2 text-xs text-gray-500">
          Füge FAQs als Array von Objekten hinzu, z.B.{' '}
          <code>{'[{"q": "Frage?", "a": "Antwort."}]'}</code>.
        </p>
      </div>
      ...
      <div>
        ...
        />
        <p className="mt-2 text-xs text-gray-500">
          Eine Regel pro Zeile. Diese Regeln definieren das Verhalten des Bots (z.B. &ldquo;Antworte
          immer auf Deutsch.&rdquo;).
        </p>
      </div>

      <div>
        <label htmlFor="coreProcesses" className="block text-sm font-medium text-gray-700">
          Kernprozesse (Handlungsanweisungen)
        </label>
        <textarea
          name="coreProcesses"
          id="coreProcesses"
          rows={8}
          defaultValue={coreProcessesString}
          className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
        />
        <p className="mt-2 text-xs text-gray-500">
          Eine Anweisung pro Zeile. Beschreibe, wie der Bot bei spezifischen Anfragen (z.B.
          Stornierung) reagieren soll.
        </p>
      </div>
