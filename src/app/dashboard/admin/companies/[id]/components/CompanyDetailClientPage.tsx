...
const getDocumentLabel = (fileName: string): string => {
    ...
    return nameOnly.split('_').join(' ').replace(/\.[^/.]+$/, "") || 'Unbenanntes Dokument';
};
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                        ...
                        {stripeAccountId ? (
                            <div className="space-y-3 text-sm">
                                ...
                                <div><span className="font-medium text-gray-500">Stripe Account ID:</span> <code className="text-xs bg-gray-100 dark:bg-gray-700 p-1 rounded">{stripeAccountId}</code></div>
                                <Link href={getStripeDashboardLink(stripeAccountId)} target="_blank" rel="noopener noreferrer" className="inline-block px-4 py-2 text-sm font-semibold text-white bg-indigo-600 rounded-md hover:bg-indigo-700">
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow">
                        ...
                        <div className="space-y-3">
                            {documents.length > 0 ? (
                                ...
                                <p className="text-sm text-gray-500 dark:text-gray-400">Keine Dokumente hochgeladen.</p>
                            )}
                        </div>
                    </div>
                </div>
