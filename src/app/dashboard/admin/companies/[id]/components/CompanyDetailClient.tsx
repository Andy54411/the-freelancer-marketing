    ...
    <div className="space-y-6">
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <ActionButtons companyId={id} companyName={displayName} />
        </CardContent>
      </Card>
      {documents.length > 0 && (
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Gespeicherte Dokumente und Nachweise des Unternehmens.
            </CardDescription>
          </CardHeader>
              ...
              >
                ...
                {doc.value.startsWith('http') ? (
                  <a
                    ...
                    className="text-[#14ad9f] hover:underline text-sm flex items-center gap-1"
                  >
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Vollständige Liste aller in der Datenbank gespeicherten Felder für diesen Benutzer.
          </CardDescription>
        </CardHeader>
        <CardContent>
