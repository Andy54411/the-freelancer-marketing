          ...
          {chats.map(chat => (
            ...
            >
              <div className="relative mr-3 flex-shrink-0">
                ...
                {chat.lastMessage &&
                  !chat.lastMessage.isReadBySupport &&
              ...
              <div className="flex-1 overflow-hidden">
                ...
                <div className="flex items-center justify-between">
                  <p
                    className={`text-sm truncate ${chat.lastMessage && !chat.lastMessage.isReadBySupport && chat.lastMessage.senderId !== user?.uid ? 'text-gray-800 font-medium' : 'text-gray-600'}`}
                  >
                    {chat.lastMessage?.text}
                  </p>
                  {chat.status === 'bot' && (
                    <span title="Wird von Bot bearbeitet">
                      <FiCpu className="text-teal-500 ml-2 flex-shrink-0" />
                    </span>
                  )}
                </div>
              </div>
