...
export function UserProfileSettingsForm({ uid, onSaveSuccess, onSaveError }: UserProfileSettingsFormProps) {
    ...
    useEffect(() => {
        const loadUserData = async (user: FirebaseAuthUser, targetUid: string) => {
            try {
                ...
                if (docSnap.exists()) {
                    ...
                    console.warn(`UserProfileSettingsForm: Nutzerdokument für UID ${targetUid} nicht gefunden. Initialisiere leeres Profil.`);
                }
            } catch (error) {
        ...
        const unsubscribeAuth = onAuthStateChanged(auth, (user) => {
            ...
            if (user.uid === targetUid) {
                ...
                console.warn(`UserProfileSettingsForm: UID-Mismatch. Angemeldet als ${user.uid}, Komponente ist für ${targetUid}.`);
                setIsLoading(false);
    ...
    if (isLoading || !currentUser || !profileData) {
        return (
            <div className="flex justify-center items-center p-6 min-h-[300px]"> {/* min-h für besseres Laden */}
    ...
    return (
        <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-8">
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Dein Profil bearbeiten</h1>
            ...
            <form onSubmit={handleSave} className="space-y-6">
                ...
                <div>
                    <label htmlFor="phone" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Telefonnummer</label>
                    <input
                        type="tel"
                        id="phone"
                        name="phone"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label htmlFor="jobStreet" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Straße & Hausnummer</label>
                        <input
                            type="text"
                            id="jobStreet"
                            name="jobStreet"
                    ...
                    <div>
                        <label htmlFor="jobPostalCode" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Postleitzahl</label>
                        <input
                            type="text"
                            id="jobPostalCode"
                            name="jobPostalCode"
                    ...
                    <div>
                        <label htmlFor="jobCity" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Stadt</label>
                        <input
                            type="text"
                            id="jobCity"
                            name="jobCity"
                    ...
                    <div>
                        <label htmlFor="jobCountry" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Land</label>
                        <input
                            type="text"
                            id="jobCountry"
                            name="jobCountry"
