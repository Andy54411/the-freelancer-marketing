...
export default function CreateProjectRequestPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toast.error(error instanceof Error ? error.message : 'Fehler beim Erstellen der Projektanfrage');
    } finally {
  ...
  const renderStep1 = () => (
    <div className="space-y-6">
      <div>
        <Label htmlFor="title" className="text-[#14ad9f] font-medium">Projekt Titel *</Label>
        <Input
          id="title"
      ...
      <div>
        <Label htmlFor="description" className="text-[#14ad9f] font-medium">Projektbeschreibung *</Label>
        <Textarea
          id="description"
      ...
      <div className="space-y-4">
        <div>
          ...
          <p className="text-[#14ad9f]/90 text-sm mb-4">
            Wie möchten Sie für Ihr Projekt bezahlen? Dies hilft Anbietern, passende Angebote zu erstellen.
          </p>
        </div>
        ...
        <div>
          ...
          <Select 
            ...
            onValueChange={(value: 'fixed' | 'hourly' | 'negotiable') => handleInputChange('budgetType', value)}
          >
            <SelectTrigger className="mt-2 bg-white/95 backdrop-blur-sm border-white/20">
            ...
            <SelectContent>
              <SelectItem value="fixed">
                <div className="flex flex-col">
                  ...
                  <span className="text-xs text-gray-500">Einmalzahlung für das komplette Projekt</span>
                </div>
              </SelectItem>
              <SelectItem value="hourly">
                <div className="flex flex-col">
                  <span className="font-medium">Stundenbasis</span>
                  <span className="text-xs text-gray-500">Bezahlung nach tatsächlich geleisteten Stunden</span>
                </div>
              </SelectItem>
              <SelectItem value="negotiable">
                <div className="flex flex-col">
                  <span className="font-medium">Verhandelbar</span>
                  <span className="text-xs text-gray-500">Budget wird mit Anbietern besprochen</span>
                </div>
              </SelectItem>
            </SelectContent>
          </Select>
        ...
        {formData.budgetType === 'fixed' && (
          <div className="bg-white/10 p-4 rounded-lg">
            ...
            <Input
              ...
              onChange={(e) => handleInputChange('budgetAmount', parseFloat(e.target.value) || undefined)}
              className="mt-2 bg-white/95 backdrop-blur-sm border-white/20"
            />
          </div>
        )}
          ...
          <div className="bg-white/10 p-4 rounded-lg space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) => handleInputChange('maxBudget', parseFloat(e.target.value) || undefined)}
                className="mt-2 bg-white/95 backdrop-blur-sm border-white/20"
              />
            </div>
          </div>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <p className="text-[#14ad9f]/80 text-sm mt-1 mb-3">
              Wie umfangreich ist Ihr Projekt?
            </p>
            <Select 
              value={formData.projectSize} 
              onValueChange={(value: 'small' | 'medium' | 'large') => handleInputChange('projectSize', value)}
            >
              <SelectTrigger className="mt-2 bg-white/95 backdrop-blur-sm border-white/20">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#14ad9f] via-teal-600 to-blue-600 relative -m-4 lg:-m-6 -mt-16">
      ...
      <div className="relative z-10 pt-20 pb-12 px-4 lg:px-6">{/* Adjusted padding */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <Card className="bg-white/10 backdrop-blur-sm border-white/20 text-white">
                    <CardContent className="p-6 text-center">
                      ...
                      <p className="text-sm text-white/80">
                        Geschützte Zahlungen und Bewertungssystem
                      </p>
                    </CardContent>
                  </Card>
                </div>
