...
const UserSettingsPage: React.FC<UserSettingsPageProps> = ({ userData, onDataSaved }) => {
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            // Event auslösen, wenn sich die Profilbild-URL tatsächlich geändert hat
            // und newProfilePictureURL einen gültigen Wert hat.
            if (newProfilePictureURL && newProfilePictureURL !== (userData?.profilePictureURL || '')) {
                console.log('[UserSettingsPage] Dispatching profileUpdated event with URL:', newProfilePictureURL);
