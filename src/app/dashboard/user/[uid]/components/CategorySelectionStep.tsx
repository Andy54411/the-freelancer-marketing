...
export function CategorySelectionStep({ onNext }: CategorySelectionStepProps) {
  ...
  const [selectedCategoryTitle, setSelectedCategoryTitle] = useState<string | null>(
    registration.selectedCategory || null
  );
  const [selectedSubcategory, setSelectedSubcategory] = useState<string | null>(
    registration.selectedSubcategory || null
  );

  const currentCategory = ALL_SERVICE_CATEGORIES.find(cat => cat.title === selectedCategoryTitle);
