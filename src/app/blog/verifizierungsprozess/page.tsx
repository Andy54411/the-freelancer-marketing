      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="prose prose-lg max-w-none mb-12">
          <p className="text-xl text-gray-700 leading-relaxed">
            Bei Taskilo setzen wir auf <strong>höchste Qualitäts- und Sicherheitsstandards</strong>.
            Jeder Anbieter durchläuft unseren mehrstufigen Verifizierungsprozess, bevor er Services
            auf unserer Plattform anbieten kann. Hier erklären wir Ihnen transparent, was genau wir
            prüfen.
          </p>
        </div>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-5 h-5 text-[#14ad9f] mt-0.5 flex-shrink-0" />
                      <span>
                        <strong>Referenz-Validierung:</strong> Überprüfung von Kundenbewertungen und
                        Referenzen
                      </span>
                    </li>
                  </ul>
                ...
                <div className="space-y-4">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-start space-x-2">
                      <CheckCircle className="w-5 h-5 text-[#14ad9f] mt-0.5 flex-shrink-0" />
                      <span>
                        <strong>Probeauftrag:</strong> Bei Premium-Anbietern führen wir Testaufträge
                        durch
                      </span>
                    </li>
                    <li className="flex items-start space-x-2">
                  ...
                  <div className="bg-purple-50 p-4 rounded-lg">
                    <p className="text-purple-800">
                      <strong>Premium-Qualität:</strong> Anbieter mit &quot;Verifiziert&quot; Badge
                      haben alle Prüfungen mit Bestnote bestanden und werden regelmäßig überwacht.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="mt-16">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 rounded-xl p-6 text-center">
              ...
              <p className="text-gray-600 mb-4">Identitätsprüfung und grundlegende Qualifikation</p>
        ...
        {/* Call to Action */}
        <div className="mt-16 bg-gradient-to-r from-[#14ad9f] to-[#129488] rounded-xl p-8 text-white text-center">
