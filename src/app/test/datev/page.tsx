...
export default function DatevTestPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">DATEV API Multi-Endpoint Test</h1>
        <p className="text-gray-600">Teste alle DATEV APIs gleichzeitig mit echten OAuth-Tokens</p>
      </div>
      ...
      {results.length > 0 && (
        <div className="space-y-6">
          <h2 className="text-2xl font-semibold text-gray-900 mb-4">Test Ergebnisse:</h2>
            ...
            {results.map((result, index) => (
              <div key={index} className="border border-gray-200 rounded-lg p-4">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  {result.duration && (
                    <span className="text-sm text-gray-500 ml-auto">{result.duration}ms</span>
                  )}
                </div>

                {result.status === 'loading' && (
                  <div className="text-gray-500">Teste API-Endpoint...</div>
                )}

                {result.status === 'success' && result.data && (
                  <div className="space-y-2">
                    <div className="text-sm text-green-600 font-medium">✅ Erfolgreich!</div>
                ...
                {result.status === 'error' && (
                  <div className="space-y-2">
                    <div className="text-sm text-red-600 font-medium">❌ Fehler aufgetreten</div>
      ...
      <div className="mt-8 bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <ul className="text-sm text-blue-700 space-y-1">
          <li>
            <strong>UserInfo Test API:</strong> OIDC-konforme /userinfo Endpoint
            (Referenz-Implementation)
          </li>
          <li>
            <strong>UserInfo API:</strong> Liefert DATEV User-Informationen (funktioniert perfekt)
          </li>
          <li>
            <strong>Master Data API:</strong> Multi-Endpoint Testing für Kundenstammdaten
          </li>
          <li>
            <strong>Master Data API:</strong> Multi-Endpoint Testing für Master-Data-Clients
          </li>
        </ul>
      </div>
      ...
      <div className="mt-6 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
        ...
        <ul className="text-sm text-yellow-700 space-y-1">
          <li>
            ✅ <strong>X-Client-ID Header:</strong> 6111ad8e8cae82d1a805950f2ae4adc4
          </li>
          <li>
            ✅ <strong>Korrekte Authorization:</strong> Bearer Token aus HTTP-only Cookie
          </li>
          <li>
            ✅ <strong>User-Agent:</strong> Taskilo-DATEV-Integration/1.0
          </li>
          <li>
            ✅ <strong>Accept Header:</strong> application/json
          </li>
        </ul>
      </div>
    </div>
