          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-8 space-y-6">
            ...
            <section>
              ...
              <div className="text-gray-700 dark:text-gray-300 space-y-4">
                ...
                <p>Taskilo ist nicht selbst Vertragspartner der zwischen Kunden und Dienstleistern geschlossenen Dienstleistungsverträge.</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-gray-700 dark:text-gray-300 space-y-4">
                <p>Für die Nutzung bestimmter Funktionen der Plattform ist eine Registrierung erforderlich. Bei der Registrierung müssen Sie wahrheitsgemäße und vollständige Angaben machen.</p>
                <p>Sie sind verpflichtet, Ihre Zugangsdaten vertraulich zu behandeln und vor unbefugtem Zugriff zu schützen.</p>
                <p>Sie sind für alle Aktivitäten verantwortlich, die unter Ihrem Nutzerkonto durchgeführt werden.</p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-gray-700 dark:text-gray-300 space-y-4">
                <p>Die Nutzung der Plattform ist nur für rechtliche Zwecke gestattet. Insbesondere ist es untersagt:</p>
                <ul className="list-disc list-inside ml-4 space-y-2">
            ...
            <section>
              ...
              <div className="text-gray-700 dark:text-gray-300 space-y-4">
                <p>Die Nutzung der Grundfunktionen der Plattform ist kostenlos. Für bestimmte Premium-Features können Gebühren anfallen, die vor der Nutzung transparent kommuniziert werden.</p>
            ...
            <section>
              ...
              <div className="text-gray-700 dark:text-gray-300 space-y-4">
                <p>Taskilo haftet nur für Schäden, die auf einer vorsätzlichen oder grob fahrlässigen Pflichtverletzung beruhen.</p>
                <p>Für die Qualität der über die Plattform angebotenen Dienstleistungen übernimmt Taskilo keine Haftung.</p>
            ...
            <section>
              ...
              <div className="text-gray-700 dark:text-gray-300 space-y-4">
                <p>Der Schutz Ihrer personenbezogenen Daten ist uns wichtig. Einzelheiten zur Datenverarbeitung finden Sie in unserer Datenschutzerklärung.</p>
              </div>
            </section>
