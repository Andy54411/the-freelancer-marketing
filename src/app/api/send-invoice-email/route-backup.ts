...
export async function POST(request: NextRequest) {
  try {
    ...
    // Spezifische Fehlerbehandlung - nur bei echten Resend-Service-Problemen
    if (error.message?.includes('RESEND_API_KEY')) {
      ...
      // Verwende die ursprüngliche Fehlermeldung
      errorMessage = error.message || 'Unbekannter Fehler beim Versenden der Rechnung';
    }
