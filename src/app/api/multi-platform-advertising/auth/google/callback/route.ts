  ...
  try {
    ...
    const tokenResponse = await fetch('https://oauth2.googleapis.com/token', {
      ...
      body: new URLSearchParams({
        code,
        client_id: process.env.GOOGLE_CLIENT_ID || '1022290879475-ca1lvf8o1sau2f1gakf4qro1ondrfpti.apps.googleusercontent.com',
        client_secret: process.env.GOOGLE_CLIENT_SECRET || 'GOCSPX-dummy', // Für Development - wird in Production gesetzt
        redirect_uri: `${baseUrl}/api/multi-platform-advertising/auth/google/callback`,
