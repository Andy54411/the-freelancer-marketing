...
// POST /api/webmail/drive/shares/token/[token]/reject - Share über Token ablehnen
export async function POST(
  ...
  try {
    ...
    const response = await fetch(`${WEBMAIL_PROXY_URL}/api/drive/shares/token/${token}/reject`, {
      method: 'POST',
      headers: {
