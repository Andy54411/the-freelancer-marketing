...
import { CheckCircle, ArrowRight, Clock, Shield, Loader2, AlertCircle } from 'lucide-react';
...
function ErfolgContent() {
  ...
  const tempDraftId = searchParams.get('orderId'); // Das ist die tempDraftId
          ...
          <CardContent className="p-6 space-y-6">
            ...
            {finalOrderId && (
              <div className="flex items-start gap-4 p-4 bg-green-50 border border-green-200 rounded-lg">
                ...
                <div>
                  <h3 className="font-semibold text-green-800">Auftrag erstellt</h3>
                  <p className="text-sm text-green-700 mt-1">
                    Ihr Auftrag wurde erfolgreich erstellt. Der Dienstleister wird benachrichtigt 
                    und kann den Auftrag annehmen.
                  </p>
                </div>
              </div>
            )}
