    ...
    <>
      <div className="pt-4 border-t border-gray-200">
        ...
        <div className="grid grid-cols-2 gap-2 mt-2 text-sm text-gray-600">
          ...
          <label
            ...
            className={`flex items-center p-2 border rounded-md cursor-pointer transition-all duration-200 ${currentSelectedTimeRangeKey === null ? 'bg-[#ecfdfa] border-[#14ad9f]' : 'bg-white hover:bg-gray-50'}`}
          >
            <input
              type="radio"
              id="timeFlexible"
          ...
          <label
            htmlFor="timeMorning"
            className={`flex items-center p-2 border rounded-md cursor-pointer transition-all duration-200 ${currentSelectedTimeRangeKey === 'morning' ? 'bg-[#ecfdfa] border-[#14ad9f]' : 'bg-white hover:bg-gray-50'}`}
          >
            <input
              type="radio"
              id="timeMorning"
          ...
          <label
            htmlFor="timeAfternoon"
            className={`flex items-center p-2 border rounded-md cursor-pointer transition-all duration-200 ${currentSelectedTimeRangeKey === 'afternoon' ? 'bg-[#ecfdfa] border-[#14ad9f]' : 'bg-white hover:bg-gray-50'}`}
          >
            <input
              type="radio"
              id="timeAfternoon"
          ...
          <label
            htmlFor="timeEvening"
            className={`flex items-center p-2 border rounded-md cursor-pointer transition-all duration-200 ${currentSelectedTimeRangeKey === 'evening' ? 'bg-[#ecfdfa] border-[#14ad9f]' : 'bg-white hover:bg-gray-50'}`}
          >
            <input
              type="radio"
              id="timeEvening"
      ...
      <div className="pt-4 border-t border-gray-200">
        ...
        >
          ...
          {generalTimeOptionsForSidebar.map((time: string) => (
