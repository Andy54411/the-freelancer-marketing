            ...
            <div className="prose prose-teal max-w-none text-gray-700">
              ...
              <div className="mb-8">
                ...
                <p className="leading-relaxed">
                  {job.company} sucht Verstärkung! Werde Teil unseres Teams in {job.location}.
                  Wir stehen für Qualität, Leidenschaft und Gastfreundschaft.
                </p>
              </div>
              ...
              <div className="bg-teal-50 p-6 rounded-lg border border-teal-100 mt-12">
                ...
                <Button variant="outline" className="bg-white border-teal-200 text-teal-700 hover:bg-teal-100 hover:text-teal-800">
