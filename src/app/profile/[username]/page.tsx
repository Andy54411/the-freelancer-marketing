...
import { FiMapPin, FiMessageSquare, FiStar, FiAward, FiBriefcase, FiBookOpen, FiHeart, FiPlusCircle, FiEdit3, FiShare2, FiEye, FiLoader, FiAlertCircle, FiClock, FiCheckCircle, FiTrendingUp, FiZap, FiChevronDown } from 'react-icons/fi'; // HINZUGEFÜGT: FiLoader, FiAlertCircle
                                ...
                                {profile.badges && profile.badges.length > 0 && (
                                    <div className="flex flex-wrap gap-1 mt-2">
                                        {profile.badges.map(badge => (
                                            <span key={badge} className="bg-yellow-100 text-yellow-800 text-xs px-2 py-1 rounded-full flex items-center gap-1">
                            ...
                            <div className="bg-white p-6 rounded-lg shadow">
                                ...
                                <div className="space-y-3 text-sm">
                                    ...
                                    {profile.completionRate && (
                                        <div className="flex justify-between"><span>Erfolgsrate:</span> <span className="font-medium text-green-600 flex items-center gap-1"><FiCheckCircle size={12} /> {profile.completionRate}%</span></div>
                                    )}
                                    {profile.totalOrders && (
                                ...
                                <div className="bg-gradient-to-r from-[#14ad9f] to-teal-600 text-white p-6 rounded-lg shadow-lg">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-teal-100">Starten Sie noch heute mit einem professionellen Service!</p>
                                        </div>
                            ...
                            {services.length > 0 && (
                                <div className="bg-white p-6 rounded-lg shadow">
                                    <div className="flex justify-between items-center mb-4">
                                        <h2 className="text-xl font-semibold text-gray-800">Angebotene Dienstleistungen</h2>
                            ...
                            <div className="bg-white p-6 rounded-lg shadow">
                                    ...
                                    {reviews.length > 0 && (
                                        <div className="flex items-center gap-2">
                                            <div className="flex items-center gap-1 text-yellow-500">
                                                ...
                                                <span className="font-semibold">{(reviews.reduce((acc, r) => acc + r.rating, 0) / reviews.length).toFixed(1)}</span>
                                            </div>
                                ...
                                {reviews.length > 0 ? (
                                                    ...
                                                    <div className="flex items-start space-x-3">
                                                        ...
                                                        <div className="flex-1">
                                                            <div className="flex items-center justify-between mb-1">
                                                                ...
                                                                <span className="text-xs text-gray-500">{new Date(review.date.seconds * 1000).toLocaleDateString('de-DE')}</span>
                                                            </div>
                                    ...
                                    <div className="text-center py-8">
                                        ...
                                        <p className="text-xs text-gray-400 mt-1">Seien Sie der Erste, der eine Bewertung abgibt!</p>
                                    </div>
                                )}
                            </div>
                                    ...
                                    {[
                                        {
                                            ...
                                            answer: "Zuerst besprechen wir Ihre Anforderungen im Detail. Dann erstelle ich einen konkreten Projektplan mit Zeitrahmen und Meilensteinen. Sie erhalten regelmäßige Updates zum Fortschritt."
                                        },
                                        {
                                            question: "Bieten Sie Überarbeitungen an?",
                                            answer: "Ja, bei allen Paketen sind Überarbeitungen inklusive. Die genaue Anzahl hängt vom gewählten Paket ab."
                                        },
                                        {
                                            question: "Wie schnell antworten Sie auf Nachrichten?",
                                            answer: "Ich antworte normalerweise innerhalb von 2-4 Stunden während der Geschäftszeiten."
                                        },
                                        {
                                            question: "Arbeiten Sie auch am Wochenende?",
                                            answer: "Bei dringenden Projekten bin ich auch am Wochenende verfügbar. Dies besprechen wir vorab individuell."
                                        }
                                    ].map((faq, index) => (
                                        <div key={index} className="border rounded-lg">
                                            ...
                                            >
                                                ...
                                                <FiChevronDown className={`transform transition-transform ${expandedFaq === index ? 'rotate-180' : ''}`} />
                                            </button>
                                            {expandedFaq === index && (
