...
export const TAX_RULES: TaxRule[] = [
  ...
  },
  {
    ...
    taxRate: 0,
    invoiceText:
      'Steuerschuldnerschaft des Leistungsempfängers nach Art. 196 MwStSystRL\nReverse charge according to Art. 196 VAT Directive',
  ...
  },
  {
    ...
    validCountries: ['EU'],
    requirements: [
      'Empfänger muss Unternehmer sein',
      'Gültige EU USt-IdNr. erforderlich',
  ...
  },
  {
    ...
    taxRate: 0,
    invoiceText:
      'Nicht steuerbare Leistung (Leistungsort nicht in Deutschland)\nNon-taxable service (place of service not in Germany)',
