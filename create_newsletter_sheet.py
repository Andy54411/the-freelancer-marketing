...
print("📊 Google Sheets für Newsletter-Abonnenten erstellen...")
...
try:
    ...
    print("🎉 Google Sheets Setup erfolgreich abgeschlossen!")
    
except Exception as e:
    print(f"❌ Fehler beim Erstellen des Spreadsheets: {e}")
    print("💡 Möglicherweise fehlen Berechtigungen oder der Private Key ist falsch formatiert")
